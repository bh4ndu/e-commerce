...
<body>
    <h1>Modulo de productos electronicos</h1><br>
  <div class="card">
    <div class="card-body">
            ...
            <div class="table-responsive table-card">
                <table class="table align-middle table-nowrap table-striped-columns mb-0">
                    ...
                    <tbody>
                        ...
                        @foreach($electronicos as $electronico)
                            <tr>
                                <td>{{ $contador }}</td>
                                <td>{{ $electronico->nombre }}</td>
                                <td>{{ $electronico->foto }}</td>
                                <td>{{ $electronico->precio }}</td>
                                <td>{{ $electronico->marca }}</td>
                                <td>{{ $electronico->caracteristicas }}</td>
                                <td>{{ $electronico->stock }}</td>
                            </td>
                                <td class="acciones">
